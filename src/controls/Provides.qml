    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            Maui.TextField {
                ...
                font.pixelSize: 20
                placeholderText: "Find packages that provide a specific capability, file or symbol .."
                leftPadding: 15

                onTextChanged: gridView.opacity = 0.2

                onAccepted: {
                    task.setOperation("get-provides")
                    task.setQuery(text)
                    task.start()
                }
        ...
        ColumnLayout {
            ...
            Label {
                ...
                font.pixelSize: 20
                text: provideListFiltered.count + " results"
